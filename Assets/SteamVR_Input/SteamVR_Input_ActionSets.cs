...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_HakatonNeft p_HakatonNeft;
        ...
        public static SteamVR_Input_ActionSet_HakatonNeft HakatonNeft
        {
            get
            {
                return SteamVR_Actions.p_HakatonNeft.GetCopy<SteamVR_Input_ActionSet_HakatonNeft>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_HakatonNeft = ((SteamVR_Input_ActionSet_HakatonNeft)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_HakatonNeft>("/actions/HakatonNeft")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.HakatonNeft};
        }
    }
}
